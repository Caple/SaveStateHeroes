...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <form id="runatserver" runat="server" style="width: 100%; height: 100%">
            <div id="message">
                <div>If you are seeing this page then your DNS cache is out of date.</div><br />
                <div> Fix for :
                    <a href="http://superuser.com/questions/203674/how-to-clear-flush-the-dns-cache-in-google-chrome">For Chrome</a> -  
                    <a href="http://www.kahunaburger.com/2009/03/18/clear-dns-cache-in-firefox/">For Firefox</a>
                </div><br />
