...
<?php } $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; if ($_postrow_val['S_FIRST_UNREAD']) {  ?><a id="unread"></a><?php } ?>
		...
		<div class="cat-head"><div class="cat-title"><span><a href="#p<?php echo $_postrow_val['POST_ID']; ?>"><?php echo $_postrow_val['POST_SUBJECT']; ?></a></span></div><div style="float: right;"><div class="cat-title"><span><?php echo $_postrow_val['POST_DATE']; ?></span></div></div></div>
		<div class="forum-box">	
			<ul class="post-row<?php if ($_postrow_val['S_POST_REPORTED']) {  ?>-reported<?php } ?>">
				<li>
		<div class="postbody">
